...
public class BeingAsyncTask
    ...
    public Void doInBackground(PalantiriPresenter... presenters) {
        ...
        for (;
            ...
            try {
                ...
                // been cancelled.
                // TODO -- you fill in here by replacing "false" with - check
                ...
                // TODO -- you fill in here with the appropriate - check
                // call to an AsyncTask method.
                publishProgress(presenter.mView.get().markWaiting(mIndex));
                Log.i("doInBackground", "Being #" + mIndex + " marked as waiting");
                ...
                Log.i("doInBackground", "Palantir #" + palantir.getId() + " marked as used");

                // Show that we're gazing on the screen.
                // TODO -- you fill in here with the appropriate - check
                // call to an AsyncTask method.
                publishProgress(presenter.mView.get().markGazing(mIndex));
                Log.i("doInBackground", "Being #" + mIndex + " marked as gazing");
                ...
                Log.i("doInBackground", "Being #" + mIndex + " marked as free");

                // Mark the Palantir as being free.
                // TODO -- you fill in here with the appropriate call - check
                // to an AsyncTask method.
                Utils.pauseThread(500);
                publishProgress(presenter.mView.get().markFree(palantir.getId()));
                Log.i("doInBackground", "Palantir #" + palantir.getId() + " marked as free");
    ...
    public void onProgressUpdate(Runnable ...runnableCommands) {
        // TODO -- you fill in here with the appropriate call to - check
        // the runnableCommands that will cause the progress
        // update to be displayed in the UI thread.
        Log.i("onProgressUpdate", "RunnableCommands size: " + runnableCommands.length);
